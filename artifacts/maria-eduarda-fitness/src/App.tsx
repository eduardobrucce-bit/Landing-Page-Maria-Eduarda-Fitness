  ...
  return <section id="sobre" className="section-pad bg-[hsl(var(--secondary)/.45)]">
    <div className="container-page grid items-center gap-14 md:grid-cols-[.88fr_1.12fr]">
      <div className="relative mx-auto w-full max-w-[450px] reveal">
        ...
        <div className="absolute -bottom-8 -right-6 z-10 w-36 overflow-hidden rounded-2xl border-4 border-[hsl(var(--background))] bg-[hsl(var(--primary))] shadow-[0_16px_40px_hsl(0_0%_0%/.35)] sm:w-44">
          <img src="/giga-kitty-mascot.png" alt="Mascote Giga Kitty treinando" className="aspect-square w-full object-cover" />
          <span className="block px-3 py-2 text-[10px] font-bold uppercase tracking-[.12em] text-white">Força Giga Kitty</span>
        </div>
